...
('000.111.222-33', 'Tatiane', 'Monteiro', '1991-02-23', '700000000000020', 'F', '21909876542', 'Rua das Acácias', 'Parque das Árvores', 1717),
-- 30 Medico
...
('000.222.444-66', 'Isadora', 'Monteiro', '1994-05-21', '700000000000060', 'F', '31999887744', 'Rua das Acácias', 'Parque das Árvores', 5757),  
...
INSERT INTO profissionais_saude (cpf, id_profissional, turno, data_admissao, status) VALUES
-- Primeiros 10 (Medicos)
('123.987.654-32', 'MED001', 'Manhã', '2018-05-12', 'Ativo'),
('456.789.123-45', 'MED002', 'Tarde', '2019-03-22', 'Ativo'),
('789.123.456-78', 'MED003', 'Noite', '2017-11-15', 'Ativo'),
('321.654.987-09', 'MED004', 'Manhã', '2020-02-10', 'Ativo'),
('654.987.321-01', 'MED005', 'Tarde', '2016-09-05', 'Ativo'),
('987.321.654-12', 'MED006', 'Noite', '2021-07-18', 'Ativo'),
('135.246.357-48', 'MED007', 'Manhã', '2019-08-30', 'Ativo'),
('246.357.159-26', 'MED008', 'Tarde', '2018-04-25', 'Ativo'),
('357.159.246-37', 'MED009', 'Noite', '2020-12-14', 'Ativo'),
('159.246.357-18', 'MED010', 'Manhã', '2022-01-07', 'Ativo'),

-- Próximos 10 (Enfermeiros)
('111.222.333-43', 'ENF011', 'Tarde', '2017-06-19', 'Ativo'),
('222.333.434-55', 'ENF012', 'Noite', '2019-10-08', 'Ativo'),
('333.424.555-66', 'ENF013', 'Manhã', '2018-08-11', 'Ativo'),
('444.515.666-77', 'ENF014', 'Tarde', '2020-05-23', 'Ativo'),
('555.666.577-88', 'ENF015', 'Noite', '2016-12-30', 'Ativo'),
('666.717.888-99', 'ENF016', 'Manhã', '2021-04-17', 'Ativo'),
('777.488.999-00', 'ENF017', 'Tarde', '2019-09-03', 'Ativo'),
('883.999.000-11', 'ENF018', 'Noite', '2017-07-22', 'Ativo'),
('999.400.111-22', 'ENF019', 'Manhã', '2020-11-15', 'Ativo'),
('020.111.222-33', 'ENF020', 'Tarde', '2018-02-28', 'Ativo'),

-- Próximos 10 (Agentes Comunitários)
('123.456.789-09', 'AGC001', 'Manhã', '2019-01-14', 'Ativo'),
('234.567.890-12', 'AGC002', 'Tarde', '2018-06-27', 'Ativo'),
('345.678.901-23', 'AGC003', 'Manhã', '2020-03-09', 'Ativo'),
('456.789.012-34', 'AGC004', 'Tarde', '2017-12-05', 'Ativo'),
('567.890.123-45', 'AGC005', 'Manhã', '2021-08-16', 'Ativo'),
('678.901.234-56', 'AGC006', 'Tarde', '2019-05-21', 'Ativo'),
('789.012.345-67', 'AGC007', 'Manhã', '2018-10-12', 'Ativo'),
('890.123.456-78', 'AGC008', 'Tarde', '2020-07-24', 'Ativo'),
('901.234.567-89', 'AGC009', 'Manhã', '2017-04-18', 'Ativo'),
('012.345.678-90', 'AGC010', 'Tarde', '2022-02-03', 'Ativo'),

-- Próximos 10 (Recepcionistas)
('111.333.555-77', 'REC001', 'Manhã', '2018-09-11', 'Ativo'),
('222.444.666-88', 'REC002', 'Tarde', '2019-12-22', 'Ativo'),
('333.555.777-99', 'REC003', 'Manhã', '2020-06-15', 'Ativo'),
('444.666.888-00', 'REC004', 'Tarde', '2017-08-30', 'Ativo'),
('555.777.999-11', 'REC005', 'Manhã', '2021-03-07', 'Ativo'),
('666.888.000-22', 'REC006', 'Tarde', '2018-11-19', 'Ativo'),
('777.999.111-33', 'REC007', 'Manhã', '2019-07-25', 'Ativo'),
('888.000.222-44', 'REC008', 'Tarde', '2020-01-14', 'Ativo'),
('999.111.333-55', 'REC009', 'Manhã', '2017-05-28', 'Ativo'),
('000.222.444-66', 'REC010', 'Tarde', '2021-10-05', 'Ativo'),

-- Últimos 10 (Técnicos de Enfermagem)
('123.555.789-01', 'TEC001', 'Noite', '2018-04-16', 'Ativo'),
('234.666.890-12', 'TEC002', 'Noite', '2019-11-27', 'Ativo'),
('345.777.901-23', 'TEC003', 'Noite', '2020-08-13', 'Ativo'),
('456.888.012-34', 'TEC004', 'Noite', '2017-10-09', 'Ativo'),
('567.999.123-45', 'TEC005', 'Noite', '2021-05-22', 'Ativo'),
('678.000.234-56', 'TEC006', 'Noite', '2019-02-18', 'Ativo'),
('789.111.345-67', 'TEC007', 'Noite', '2018-07-31', 'Ativo'),
('890.222.456-78', 'TEC008', 'Noite', '2020-03-26', 'Ativo'),
('901.333.567-89', 'TEC009', 'Noite', '2017-09-14', 'Ativo'),
('012.444.678-90', 'TEC010', 'Noite', '2021-12-08', 'Ativo');
